...
/**
 * <p>
 * When creating a new proxy using {@link ClassProxy}, you may specify a MethodFilter to select which methods should be overridden and which not.</p>
 *
 * @since 0.3
 */
public interface MethodFilter {
    ...
    /**
     * <p>
     * Returns a boolean indicating whether or not to filter a {@link Method}.</p>
     * <p>
     * In use with {@link ClassProxy}, a return value of {@code true} means to override the method in question, a {@code false} means to keep the method of the super class.</p>
     *
