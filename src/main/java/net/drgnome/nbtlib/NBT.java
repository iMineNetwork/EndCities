...
/**
 * <p>
 * A bunch of NBT tools.</p>
 * <p>
 * <i><b>Note:</b> For all the exceptions, see the "invoke" methods of {@link NBTLib}.</i></p>
 */
...
public enum NBT {
    ...
    /**
     * <p>
     * Returns the ID of the NBT Tag represented by this enum constant.</p>
     *
     * @return The ID.
     */
    public int getId() {
    ...
    /**
     * <p>
     * Converts a Bukkit {@link ItemStack} into a {@link Map}.</p>
     *
    ...
    /**
     * <p>
     * Converts a {@link Map} into a Bukkit {@link ItemStack}.</p>
     *
     * @param map The Map.
     *
    ...
    /**
     * <p>
     * <i><b>Deprecated.</b></i></p>
     * <p>
     * Converts a {@link Map} into an NBTTagCompound.</p>
     *
     ...
     * <i><b>Deprecated.</b></i></p>
     * <p>
     * Converts a {@link Tag} into an NBTTagCompound.</p>
     *
     * @param name The name of the tag.
     * @param tag The Tag.
     *
    ...
    /**
     * <p>
     * Converts an NBTTagCompound into a {@link Map}.</p>
     *
    ...
    /**
     * <p>
     * Converts an NBTTagCompound into a {@link Tag}.</p>
     *
     * @param o The NBTTagCompound.
     *
     * @return A Tag.
    ...
    /**
     * <p>
     * Loads an NBTTagCompound from a base64 encoded string.</p>
     *
    ...
    /**
     * <p>
     * Loads an NBTTagCompound from an array of bytes.</p>
     *
    ...
    /**
     * <p>
     * Loads an NBTTagCompound from an {@link InputStream}.</p>
     *
    ...
    /**
     * <p>
     * Loads an NBTTagCompound from a {@link DataInput} object.</p>
     *
    ...
    /**
     * <p>
     * Saves an NBTTagCompound to a base64 encoded string.</p>
     *
    ...
    /**
     * <p>
     * Saves an NBTTagCompound to an {@link InputStream}.</p>
     *
     * @param stream An {@link InputStream}.
     * @param o An NBTTagCompound.
     */
    ...
    /**
     * <p>
     * Saves an NBTTagCompound to a {@link DataInput} object.</p>
     *
    ...
    /**
     * <p>
     * Loads a Bukkit ItemStack from a base64 encoded string (using NBT).</p>
     *
     * @param string A base64 encoded string.
     *
    ...
    /**
     * <p>
     * Loads a Bukkit ItemStack from an array of bytes (using NBT).</p>
     *
     * @param array An array of bytes.
     *
     * @return A bukkit {@link ItemStack}.
    ...
    /**
     * <p>
     * Loads a Bukkit ItemStack from an {@link InputStream} (using NBT).</p>
     *
     * @param stream An {@link InputStream}.
     *
     * @return A bukkit {@link ItemStack}.
    ...
    /**
     * <p>
     * Loads a Bukkit ItemStack from a {@link DataInput} object (using NBT).</p>
     *
     * @param input A {@link DataInput} object.
     *
     * @return A bukkit {@link ItemStack}.
    ...
    /**
     * <p>
     * Saves a Bukkit ItemStack to a base64 encoded string (using NBT).</p>
     *
    ...
    /**
     * <p>
     * Saves a Bukkit ItemStack to an array of bytes (using NBT).</p>
     *
     * @param item A bukkit {@link ItemStack}.
     *
     * @return An array of bytes.
    ...
    /**
     * <p>
     * Saves a Bukkit ItemStack to an {@link OutputStream} (using NBT).</p>
     *
    ...
    /**
     * <p>
     * Saves a Bukkit ItemStack to a {@link DataOutput} object (using NBT).</p>
     *
    ...
    /**
     * <p>
     * Converts a Bukkit ItemStack into a Minecraft ItemStack.</p>
     *
    ...
    /**
     * <p>
     * Converts a Minecraft ItemStack into a Bukkit ItemStack.</p>
     *
    ...
    /**
     * <p>
     * Returns an {@link NBT} representing the type of a Minecraft NBTBase object.</p>
     *
     * @param o The Minecraft ItemStack.
     *
