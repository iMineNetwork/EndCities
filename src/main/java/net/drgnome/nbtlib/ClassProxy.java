...
/**
 * <p>
 * A util which allows you to create class proxies.</p>
 * <p>
 * This means if you specify a class A, then a class B which extends A will be created and, depending on the given {@link MethodFilter}, some or all non-static non-final methods which are public or protected will be overridden and dispatched to a provided {@link InvocationHandler}.</p>
 * <b>Examples:</b>
 *
 * @since 0.3
 */
public class ClassProxy {
    ...
    /**
     * <p>
     * Returns {@code true} if the given Class object is a proxy class generated by the ClassProxy class.</p>
     *
    ...
    /**
     * <p>
     * Calls the method that has been overridden by a proxy method.</p>
     *
    ...
    /**
     * <p>
     * Creates a proxy class for a given super class and instantiates it.</p>
     * <p>
     * This basically just calls {@code newInstance(superClass, null, handler, paramTypes, params)}.</p>
     *
    ...
    /**
     * <p>
     * Creates a proxy class for a given super class.</p>
     * <p>
     ...
     * Creates a proxy class for a given super class.</p>
     * <p>
     * Creates a new {@link Class} which extends a given super class which redirects all calls to public and protected methods which are non-final and non-static, on which {@code filter.filterMethod()} returns {@code true}, to a given {@link InvocationHandler}.<br />
     * Abstract methods will be defined and redirected to the InvocationHandler as well.<br />
     * For every public and protected constructor the super class has, this class will have the same constructor with an InvocationHandler as additional first parameter.</p>
     *
     * @param superClass The class on which you wish to create a proxy. Has to be public and not final, primitive, an array or an interface.
    ...
    private static int getReturn(Class type) {
        ...
        if (type.equals(Boolean.TYPE) || type.equals(Byte.TYPE) || type.equals(Character.TYPE) || type.equals(Short.TYPE) || type.equals(Integer.TYPE)) {
            return 0xac;
        }
